...
export default function UserFormDialog({ open, setOpen, onSubmit }) {
  const form = useForm({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="mb-4 bg-green-500 !rounded-md text-white hover:bg-green-600">
          Create User
        </Button>
      </DialogTrigger>
